<template>
    <div class="mb-8 pb-8 border-b border-gray-400">
        ...
        <router-link v-if="post.user" class="text-sm text-gray-800" :to="{name: 'user.show', params: {id: post.user.id}} ">{{ post.user.name }}</router-link>
        ...
        <div v-if="post.reposted_post" class="bg-gray-100 p-4 my-4 border border-gray-200">
            ...
            <router-link v-if="post.reposted_post.user" class="text-sm text-gray-800" :to="{name: 'user.show', params: {id: post.reposted_post.user.id}} ">{{ post.reposted_post.user.name }}</router-link>
